...
export default function GlobalSection({ className }: { className?: string }) {
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-20">
            ...
            <div className="w-full lg:w-[45%]">
              ...
              >
                ...
                <Link
                  href="/signup"
                  className="inline-block bg-[#ffffff] text-[#111111] px-10 py-5 rounded-full text-[17px] font-bold shadow-lg shadow-white/5 hover:bg-[#f5f5f5] hover:-translate-y-0.5 transition-all duration-300"
                >
                  Try for Free
                </Link>
              </motion.div>
