...
export default function Header({ className }: HeaderProps) {
  ...
  return (
    <>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="lg:hidden px-6 pt-3 pb-6 bg-black/95 backdrop-blur-2xl border-b border-white/10 shadow-2xl"
            >
      ...
      <section
        className={
          "relative overflow-hidden min-h-[1100px] pt-[120px] sm:pt-[140px] px-6 md:px-12 bg-black " +
          (className || "")
        }
      >
        {/* VIDEO BACKGROUND */}
